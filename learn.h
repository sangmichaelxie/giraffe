...
const static float AbsLambda = 0.98f; // this is discount to encourage progress
const static int64_t HalfMovesToMake = 8;
...
const static float LearningRateSGD = 0.0003f;
